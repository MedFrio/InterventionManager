...
class Program
{
            ...
            switch (choix?.ToLower())
            {
                case "1":
                    ...
                    try
                    {
                        ...
                        Console.WriteLine("OK Intervention créée.");
                    }
                    catch (Exception e) { Console.WriteLine($"Erreur Erreur : {e.Message}"); }
                    Pause();
                    break;
                ...
                case "3":
                    ...
                    {
                        Console.WriteLine("Attention Il faut au moins une intervention et un technicien.");
                        Pause();
                        break;
                    }
                    ...
                    Console.WriteLine("OK Technicien assigné.");
                    Pause();
                    break;

                case "4":
                    if (interventions.Count == 0) { Console.WriteLine("Attention Aucune intervention."); Pause(); break; }
                    Console.WriteLine("\nSélectionner une intervention :");
                    ...
                    Console.WriteLine("OK Décorateurs appliqués.");
                    Pause();
                    break;
                ...
                case "5":
                    ...
                    Console.WriteLine("OK État modifié.");
                    Pause();
                    break;
                ...
                case "7":
                    ...
                    Console.WriteLine("OK Technicien ajouté.");
                    Pause();
                    break;
                ...
                case "q": return;
                default:
                    Console.WriteLine("Blocage Choix invalide.");
                    Pause();
                    break;
            }
        }
    ...
    static int Choisir<T>(List<T> list)
    {
        ...
        Console.WriteLine("Blocage Sélection invalide. Revenir au menu.");
        return 0;
    }
